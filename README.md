...
Данный телеграм бот позволяет найти выгодные предложения на сайте [Hotels.com](https://hotels.com).
...
При разработке проекта использовался открытый **API Hotels**, который расположен на сайте [Rapidapi.com](https://rapidapi.com).
...
- на страницу отеля, расположенную на сайте [Hotels.com](https://hotels.com)
...
Посетите официальный сайт [Python.org](https://python.org) - там вы сможете найти всю информацию по установке Python
...
- Гиперссылка на страницу отеля на [Hotels.com](https://hotels.com)
